    ...
    specHelper.checkResponse(
      function (this: Context) {
        return specHelper.post(
          `${testConfig.baseUrl}/users/logout`,
          {},
  ...
  describe('POST /:_id/change-password - Change password', () => {
    ...
    describe('by owner', () => {
      ...
      specHelper.checkResponse(
        function (this: Context) {
          return specHelper.post(
            `${testConfig.baseUrl}/users/me/change-password`,
            {
    ...
    describe('by other user', () => {
      ...
      specHelper.checkResponse(
        function (this: Context) {
          return specHelper.post(
            `${testConfig.baseUrl}/users/${this.user._id}/change-password`,
            {
              password: this.user.password,
              newPassword,
            },
  ...
  describe('POST /forgot - Forgot password', () => {
    describe('by owner', () => {
      ...
      specHelper.checkResponse(
        function (this: Context) {
          return specHelper.post(
            `${testConfig.baseUrl}/users/forgot`,
  ...
  describe('POST _id/reset/:token - Reset password', () => {
    describe('with valid token', () => {
      ...
      specHelper.checkResponse(
        function (this: Context) {
          return specHelper.post(
            `${testConfig.baseUrl}/users/reset/${this.token}`,
    ...
    describe('with invalid token', () => {
      ...
      specHelper.checkResponse(
        () => specHelper.post(
          `${testConfig.baseUrl}/users/reset/invalidToken`,
          { ...specHelper.getClientAuth(), newPassword: 'completelyOtherPassword' },
        ),
        400,
        { mask: [] },
