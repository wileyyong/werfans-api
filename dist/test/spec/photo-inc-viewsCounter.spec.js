...
const { modelProvider: { Photo, User } } = app_1.default;
describe('Photo viewsCounter increment', () => {
    inc_field_restdone_plugin_testHelper_1.createTest(Photo, 'viewsCounter', () => {
        specHelper_1.default.withAlbum();
        specHelper_1.default.withPhoto();
    }, 'photo', (id) => `${config_1.default.baseUrl}/photos/${id}/inc/viewsCounter`, () => {
...
//# sourceMappingURL=photo-inc-viewsCounter.spec.js.map