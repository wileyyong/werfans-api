...
describe('LiveStream Purchase', () => {
    ...
    describe('enough balance', () => {
        specHelper_1.default.resetUserBalance(51);
        specHelper_1.default.checkMoleculerEventEmit(events.payment.accepted, true, {
            mask: ['_id', 'owner', 'ref'],
        });
        specHelper_1.default.checkResponse(function () {
            return specHelper_1.default.post(`${config_1.default.baseUrl}/live-streams/${this.liveStream._id}/purchase`, {}, { headers: { Authorization: `Bearer ${this.user.auth.access_token}` } });
        }, 200, {});
    ...
    describe('not enough balance', () => {
        specHelper_1.default.resetUserBalance(49);
        ...
        it('balance should not change', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const { balance: userBalance } = yield User.findById(this.user._id).select('balance').lean();
                chai_1.expect(userBalance).to.be.equal(49);
            });
        });
    });
});
//# sourceMappingURL=liveStream-purchase.spec.js.map