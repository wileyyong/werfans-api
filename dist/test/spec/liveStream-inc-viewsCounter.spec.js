...
const { modelProvider: { LiveStream, User } } = app_1.default;
describe('LiveStream viewsCounter increment', () => {
    inc_field_restdone_plugin_testHelper_1.createTest(LiveStream, 'viewsCounter', () => specHelper_1.default.withLiveStream(), 'liveStream', (id) => `${config_1.default.baseUrl}/live-streams/${id}/inc/viewsCounter`, () => {
...
//# sourceMappingURL=liveStream-inc-viewsCounter.spec.js.map