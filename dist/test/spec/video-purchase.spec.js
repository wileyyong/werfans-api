...
describe('Video Purchase', () => {
    ...
    describe('enough balance', () => {
        ...
        specHelper_1.default.checkResponse(function () {
            return specHelper_1.default.post(`${config_1.default.baseUrl}/videos/${this.video._id}/purchase`, {}, { headers: { Authorization: `Bearer ${this.user.auth.access_token}` } });
        }, 200, {});
...
//# sourceMappingURL=video-purchase.spec.js.map