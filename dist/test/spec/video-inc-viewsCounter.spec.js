...
const { modelProvider: { User, Video } } = app_1.default;
describe('Video viewsCounter increment', () => {
    inc_field_restdone_plugin_testHelper_1.createTest(Video, 'viewsCounter', () => specHelper_1.default.withVideo(), 'video', (id) => `${config_1.default.baseUrl}/videos/${id}/inc/viewsCounter`, () => {
...
//# sourceMappingURL=video-inc-viewsCounter.spec.js.map