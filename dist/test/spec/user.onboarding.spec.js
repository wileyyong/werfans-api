...
describe('User Onboarding', () => {
    ...
    before('create user', () => __awaiter(void 0, void 0, void 0, function* () { return specHelper.createUser(user, true); }));
    before('sign in user', () => __awaiter(void 0, void 0, void 0, function* () { return specHelper.signInUser(user); }));
    after('remove user', () => __awaiter(void 0, void 0, void 0, function* () { return specHelper.removeUser(user); }));
    describe('GetStatus', () => {
        describe('authorized users', () => {
            let response;
            before('send request', () => __awaiter(void 0, void 0, void 0, function* () {
                response = yield chakram.get(`${testConfig.baseUrl}/users/me/onboarding`, { headers: { Authorization: `Bearer ${user.auth.access_token}` } });
            }));
        ...
        describe('unauthorized users', () => {
            describe('not logged in', () => {
                let response;
                before('send request', () => __awaiter(void 0, void 0, void 0, function* () {
                    response = yield chakram.get(`${testConfig.baseUrl}/users/me/onboarding`, {});
                }));
    ...
    describe('ShowPopup', () => {
        describe('authorized users', () => {
            let response;
            before('send request', () => __awaiter(void 0, void 0, void 0, function* () {
                response = yield chakram.put(`${testConfig.baseUrl}/users/me/onboarding/showPopup`, {}, { headers: { Authorization: `Bearer ${user.auth.access_token}` } });
            }));
            it('should return status 200', () => expect(response).to.have.status(200));
        ...
        describe('unauthorized users', () => {
            describe('not logged in', () => {
                let response;
                before('send request', () => __awaiter(void 0, void 0, void 0, function* () {
                    response = yield chakram.put(`${testConfig.baseUrl}/users/me/onboarding/showPopup`, {});
                }));
                it('should return status 401', () => expect(response).to.have.status(401));
            });
        });
...
//# sourceMappingURL=user.onboarding.spec.js.map